 ...
 * How it works
 * ------------
 * We walk through the array with a pointer at the beginning and end of the array comparing characters
...
public class PalindromeCheckImpl implements PalindromeCheck{
    ...
    public boolean isPalindrome(String string) {
        ...
        for (int i=0; i<end;i++,end--) if (array[i] != array[end]) return false;
        return true;
    }
}

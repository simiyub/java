...
//                    });
            ...
            ChannelFuture future = bootstrap.connect(uri.getHost(),443);
                    future.addListener((ChannelFutureListener) future1 -> {
                        if(future1.isSuccess()){
                            System.out.println("connected");
                            //future1.channel().writeAndFlush(new TextWebSocketFrame(inputFromScreen()));
                        }
                        else{
...
//            }
    ...
    private static String inputFromScreen() throws IOException {

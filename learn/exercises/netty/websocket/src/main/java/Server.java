...
public class Server {
    ...
    private static final int PORT = Integer.parseInt(System.getProperty("port", Util.getSSL()!=null ? "8443":"8080"));
    ...
    private void init3() {
        ...
        bootstrap.group(new NioEventLoopGroup(), new NioEventLoopGroup())
                ...
                .childHandler(new ClientSubscriptionHandler()
...
//                                            QuoteProviderClient.getHandler()
//                                    );
...
//    }
        ...
        try {
            ...
            server.group(bossGroup, workerGroup)
                    .channel(NioServerSocketChannel.class)
                    .childHandler(
                            new ClientSubscriptionServerInitializer());

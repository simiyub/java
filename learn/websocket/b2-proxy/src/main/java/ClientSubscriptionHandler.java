...
public class ClientSubscriptionHandler extends ChannelInboundHandlerAdapter {
    ...
    public ClientSubscriptionHandler(String remoteHost, int remotePort) {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        ...
        bootstrap.group(inboundChannel.eventLoop())
                ...
                .handler(new QuoteProviderHandler(inboundChannel))
        ...
        future.addListener(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture f) {
                if (f.isSuccess()) {
                    ...
                    System.out.println("Client subscription handler active");
                    inboundChannel.read();
                } else {
                    // Close the connection if the connection attempt has failed.
                    System.out.println("Client subscription failed to connect.");
            ...
            outboundChannel.writeAndFlush(message).addListener(new ChannelFutureListener() {
                ...
                public void operationComplete(ChannelFuture future) {
                    if (future.isSuccess()) {
                        ...
                        System.out.println("Client subscription handler received data.");
